...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="media_user.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="img/demo/avatars/<?php if($id['avatar']){ echo $id['avatar'];}else{echo "no_image.png";} ;?>" alt="" class="img-responsive" width="200">
                                </div>
